    ...
    <>
      ...
      <div className="absolute w-full bg-white bg-[radial-gradient(#e5e7eb_1px,transparent_1px)] [background-size:16px_16px]">
        ...
        <div className="main mt-10">
          ...
          <div id="previews" className=" flex items-center justify-center mt-16 py-16 flex-col bg-gray-100">
              <div className="heading text-center">
                <h1 className=" text-4xl font-semibold">Explore some previews</h1>
                <p className=" text-2xl mt-4">Uncover the potential of what we can design for you</p>
              </div>
              ...
              <div className="flex itmes-center justify-evenly flex-wrap w-[900px] mt-10">
                ...
                <dialog id="retirement_modal" className="modal bg-white absolute inset-0 -z-10 h-full w-full bg-[radial-gradient(ellipse_80%_80%_at_50%_-20%,rgba(120,119,198,0.3),rgba(255,255,255,0))]" >
                      ...
                      <Image src={PreviewRetirementGif} sizes='(max-width: 200px) 100vw, 33vw' alt="RetirementImage" width={0} height={0} className="img rounded-box"/>
                        <form method="dialog">
                          <motion.button className="border-none outline-none text-2xl text-black font-light absolute top-10 right-10">
                            X</motion.button>
                        </form>
                ...
                <div className="image-container">
                    <Image data-offset='0' data-aos="fade-right"  data-aos-easing="ease-in-back" data-aos-duration="1000"
                      onClick={()=>document.getElementById('retirement_modal').showModal()} src={PreviewRetirementGif} 
                      sizes='(max-width: 200px) 100vw, 33vw'  alt="RetirementImage" width={0} height={0} 
                      className="img rounded-box"/>
                    <div className="overlay">
                      <motion.button whileTap={{scale:0.9}} className="overlay-button btn px-10 border border-white outline-none rounded-lg
                        text-white text-xl font-medium hover:shadow-xl hover:border-gray" onClick={()=>document.getElementById('retirement_modal').showModal()}>Preview <FiExternalLink /> </motion.button>
                    </div>
                </div>
                ...
                <dialog id="thankyou_modal" className="modal bg-white absolute inset-0 -z-10 h-full w-full bg-[radial-gradient(ellipse_80%_80%_at_50%_-20%,rgba(120,119,198,0.3),rgba(255,255,255,0))]">
                    <p className="text-2xl text-white" >Preview thankyou posts</p>
                ...
                <div className="image-container">
                    <Image data-offset='0' data-aos="fade-right"  data-aos-easing="ease-in-back" data-aos-duration="1000"
                      onClick={()=>document.getElementById('thankyou_modal').showModal()} src={PreviewThankyouGif} 
                      sizes='(max-width: 200px) 100vw, 33vw'  alt="RetirementImage" width={0} height={0} 
                      className="img rounded-box"/>
                    <div className="overlay">
                      <motion.button whileTap={{scale:0.9}} className="overlay-button btn  px-10 border border-white outline-none rounded-lg
                      text-white text-xl font-medium hover:shadow-xl hover:border-gray " onClick={()=>document.getElementById('thankyou_modal').showModal()}>Preview <FiExternalLink /> </motion.button>
                    </div>
                </div>
                ...
                <dialog id="graduation_modal" className="modal bg-white absolute inset-0 -z-10 h-full w-full bg-[radial-gradient(ellipse_80%_80%_at_50%_-20%,rgba(120,119,198,0.3),rgba(255,255,255,0))]">
                    <p className="text-2xl text-white" >Preview graduation posts</p>
                ...
                <div className="image-container">
                    <Image data-offset='0' data-aos="fade-right"  data-aos-easing="ease-in-back" data-aos-duration="1000"
                      onClick={()=>document.getElementById('graduation_modal').showModal()} src={PreviewGraduationGif} 
                      sizes='(max-width: 200px) 100vw, 33vw'  alt="RetirementImage" width={0} height={0} 
                      className="img rounded-box"/>
                    <div className="overlay">
                      <motion.button whileTap={{scale:0.9}} className="overlay-button btn px-10 border border-white outline-none rounded-lg
                      text-white text-xl font-medium hover:shadow-xl hover:border-gray " onClick={()=>document.getElementById('graduation_modal').showModal()}>Preview <FiExternalLink /> </motion.button>
                    </div>
                </div>
                ...
                <dialog id="birthday_modal" className="modal bg-white absolute inset-0 -z-10 h-full w-full bg-[radial-gradient(ellipse_80%_80%_at_50%_-20%,rgba(120,119,198,0.3),rgba(255,255,255,0))]">
                    <p className="text-2xl text-white" >Preview birthday posts</p>
                ...
                <div className="image-container">
                    <Image data-offset='0' data-aos="fade-right"  data-aos-easing="ease-in-back" data-aos-duration="1000"
                      onClick={()=>document.getElementById('birthday_modal').showModal()} src={PreviewBirthdayGif} 
                      sizes='(max-width: 200px) 100vw, 33vw'  alt="RetirementImage" width={0} height={0} 
                      className="img rounded-box"/>
                    <div className="overlay">
                      <motion.button whileTap={{scale:0.9}} className="overlay-button btn px-10 border border-white outline-none rounded-lg
                      text-white text-xl font-medium hover:shadow-xl hover:border-gray " onClick={()=>document.getElementById('birthday_modal').showModal()}>Preview <FiExternalLink /> </motion.button>
                    </div>
                </div>
                ...
                <dialog id="farewell_modal" className="modal bg-white absolute inset-0 -z-10 h-full w-full bg-[radial-gradient(ellipse_80%_80%_at_50%_-20%,rgba(120,119,198,0.3),rgba(255,255,255,0))]">
                    <p className="text-2xl text-white" >Preview farewell posts</p>
                ...
                <div className="image-container">
                    <Image data-offset='0' data-aos="fade-right"  data-aos-easing="ease-in-back" data-aos-duration="1000"
                      onClick={()=>document.getElementById('farewell_modal').showModal()} src={PreviewFarewellGif} 
                      sizes='(max-width: 200px) 100vw, 33vw'  alt="RetirementImage" width={0} height={0} 
                      className="img rounded-box"/>
                    <div className="overlay">
                      <motion.button whileTap={{scale:0.9}} className="overlay-button btn px-10 border border-white outline-none rounded-lg
                      text-white text-xl font-medium hover:shadow-xl hover:border-gray " onClick={()=>document.getElementById('farewell_modal').showModal()}>Preview <FiExternalLink /> </motion.button>
                    </div>
                </div>
                ...
                <dialog id="new_year_modal" className="modal bg-white absolute inset-0 -z-10 h-full w-full bg-[radial-gradient(ellipse_80%_80%_at_50%_-20%,rgba(120,119,198,0.3),rgba(255,255,255,0))]">
                    <p className="text-2xl text-white" >Preview new year posts</p>
                    <Image src={PreviewNewYearGif} sizes='(max-width: 200px) 100vw, 33vw' alt="RetirementImage" width={0} height={0} className="img rounded-box"/>
                      <form method="dialog">
                        <button className="border-none outline-none text-2xl text-black font-light absolute top-10 right-10" whileTap={{scale:0.9}}>X</button>
                      </form>
                ...
                <div className="image-container">
                    <Image data-offset='0' data-aos="fade-right"  data-aos-easing="ease-in-back" data-aos-duration="1000"
                      onClick={()=>document.getElementById('new_year_modal').showModal()} src={PreviewNewYearGif} 
                      sizes='(max-width: 200px) 100vw, 33vw'  alt="RetirementImage" width={0} height={0} 
                      className="img rounded-box"/>
                    <div className="overlay">
                      <motion.button whileTap={{scale:0.9}} className="overlay-button btn px-10 border border-white outline-none rounded-lg
                      text-white text-xl font-medium hover:shadow-xl hover:border-gray " onClick={()=>document.getElementById('new_year_modal').showModal()}>Preview <FiExternalLink /> </motion.button>
                    </div>
                </div>
        ...
        <div id="how-to" className=" how-it-works my-16 text-center ">
