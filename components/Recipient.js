        ...
        <div className='flex items-center justify-center mt-10' >
            ...
            <div className=" pb-10 pt-6 bg-white w-[500px]  border shadow rounded-lg">
                <div className="form flex items-center justify-center flex-col">
                    ...
                    <input className='input border-2 w-10/12 mt-5 border-gray-300 rounded-lg outline-none px-4' type="text" placeholder='Name' value={recipient} name='recipient' onChange={(e) => setRecipient(e.target.value)} required />
                    <button disabled={!recipient ? true : false} onClick={() => {increaseStep(); setBoardData([...boardData, recipient])}} className='board-next-button mt-8 max-sm:hidden' >Next</button>
                    <div className='sm:hidden w-full flex items-center justify-center mt-6 space-x-2'>
                        ...
                        <button disabled={!recipient ? true : false} onClick={() => {increaseStep(); setBoardData([...boardData, recipient])}} className='board-next-button' >Next</button>
                    </div>
