        ...
        <div className='flex items-center justify-center mt-10' data-offset='0' data-aos="fade"  data-aos-easing="ease-in-back" data-aos-duration="1000">
            ...
            <div className=" pb-10 pt-6 bg-white w-[500px] border shadow rounded-lg"  >
                <div className="form flex items-center justify-center flex-col" >
                    ...
                    <input className='input border-2 w-10/12 mt-5 border-gray-300 rounded-lg outline-none px-4' type="text" placeholder={`e.g. ${boardData[0]}`} value={title} name='title' onChange={(e) => setTitle(e.target.value)} required />
