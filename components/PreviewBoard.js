        ...
        <header className='fixed top-0 right-0 left-0 z-50 bg-white py-6 shadow'>
          <div className="flex items-center justify-evenly">
            ...
            <div className="description-title">
              <p className='text-lg'>Celebrate {occasion} with Board</p>
              <p className='text-lg'>Drive employee happiness by celebrating milestones with online {occasion} cards by Board</p>
            </div>
                                ...
                                <div style={{width: "400px", height:"auto"}} className="post  bg-[#202459] p-2 mt-3 ms-3 rounded-lg shadow-md " key={post._id}>
                                    ...
                                    <div className="post-image">
                                        ...
                                        { post.image ? 
                                           ...
                                           ( <img className='rounded-lg' src={`${process.env.basePath}/images/${post.gif}`} alt="GIF" style={{width:"500px", height:"400px"}} />)
